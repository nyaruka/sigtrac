...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Carrier.objects.filter(slug='mtn').update(color="FEC325")
        Carrier.objects.filter(slug='tigo').update(color="204497")
        Carrier.objects.filter(slug='airtel').update(color="EB2026")
