...
ALLOWED_HOSTS = ['.bitranks.com', '.nyaruka.com']
...
SECRET_KEY = '96#f(c%0&fi990q!a$hy^ghqd(ewf3ehi#%#5zp3$^xp9kazrg'
...
ROOT_URLCONF = 'sigtrac.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sigtrac.wsgi.application'
